...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Enter the Price" name="price" value="<?php echo $row["price"];?>">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="col-sm-10">
  <input class="form-control" type="file" id="formFileMultiple" multiple  name="pic" value="<?php echo $row["image"];?>">
  <img src="<?php echo "images/".$row["image"];?>" width="50px" height="50px">
</div>
<br><br><br>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="textarea" class="form-control" id="inputPassword3"  name="descri" value="<?php echo $row["description"];?>" placeholder="Enter the Product Description here...">
    </div>
  </div>
