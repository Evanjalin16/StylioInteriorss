...
<!----->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
						...
						<li><a href="views.html" class=" hvr-bounce-to-right"><i class="fa fa-file-text-o nav_icon"></i>View Users</a></li>
       ...
       <div class="content-main">
        ...
        <i class="fa fa-angle-right"></i>
        <a href="export.php?export=true">Export to Excel</a>
        <i class="fa fa-angle-right"></i>
        <a href="pdf.php?export=true">Download pdf</a>
...
<div class="table-responsive">
  <table class="table table-striped table-bordered">
    ...
    <?php if ($count > 0): ?>
      ...
      <td><a href="deleted.php?del=<?php echo htmlspecialchars($row["id"]); ?>"
      onclick="return confirm('Do you want to delete this?');" >Delete</a></td>
