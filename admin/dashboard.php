		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="drop-men" >
		        <ul class=" nav_1">
					...
					<li class="dropdown">
		              <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?php echo $em;?><i class="caret"></i></span><img src="images/wo.jpg"></a>
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
						...
						<li><a href="views.php" class=" hvr-bounce-to-right"><i class="fa fa-file-text-o nav_icon"></i>View User</a></li>
						<li><a href="orders.php" class=" hvr-bounce-to-right"><i class="fa fa-file-text-o nav_icon"></i>View Orders</a></li>
						<li><a href="join.php" class=" hvr-bounce-to-right"><i class="fa fa-file-text-o nav_icon"></i>View Order Details</a></li>
					   </ul>
                    </li>
					 <li>
