              ...
              <div class="row">
                  <div class="col-lg-4 col-md-6">
                      <div class="contact-address">
                          <ul>
                              <li class="icon-color"><span class="fa fa-map-marker"></span> <span>703 North Street
                                      <br>Marthandam, KK Dist.</span> </li>
                          </ul>
                      </div>
                  </div>
                  <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                      <div class="contact-address">
                          <ul>
                              <li class="icon-color"><span class="fa fa-phone"></span> <span><a class="" href="tel:+(21)-234-9999">Phone :9876543210</a>
                                 <a class="" href="tel:+(21)-234-8888">Fax :+(91)-234-8888</a></span></li>
                          </ul>
                      </div>
                  </div>
                      ...
                      <div class="contact-address">
                          <ul>
                              <li class="icon-color"><span class="fa fa-mail-reply"></span><span>
                                  <a href="mailto:travel@mail.com"> Stylio@gmail.com</a>
                                  <a href="mailto:info@travel.com"> info@Stylio.com</a>
                              </li>
                          </ul>
                      </div>
                  </div>
